...
type AuthServiceClient interface {
	AuthUser(ctx context.Context, in *common.UserID, opts ...grpc.CallOption) (*SessionToken, error)
	VerifyAuth(ctx context.Context, in *SessionToken, opts ...grpc.CallOption) (*common.UserID, error)
...
func (c *authServiceClient) AuthUser(ctx context.Context, in *common.UserID, opts ...grpc.CallOption) (*SessionToken, error) {
...
func (c *authServiceClient) VerifyAuth(ctx context.Context, in *SessionToken, opts ...grpc.CallOption) (*common.UserID, error) {
...
type AuthServiceServer interface {
	AuthUser(context.Context, *common.UserID) (*SessionToken, error)
	VerifyAuth(context.Context, *SessionToken) (*common.UserID, error)
...
func (UnimplementedAuthServiceServer) AuthUser(context.Context, *common.UserID) (*SessionToken, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AuthUser not implemented")
}
func (UnimplementedAuthServiceServer) VerifyAuth(context.Context, *SessionToken) (*common.UserID, error) {
...
func _AuthService_AuthUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).AuthUser(ctx, req.(*common.UserID))
	}
