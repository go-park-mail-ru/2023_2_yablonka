...
//
//	mockgen.exe --source=P:\VK Образование\Web\Sem_2\Project\2023_2_yablonka\internal\service\csrf.go --destination=./mocks/mock_service/mock_csrf_service.go --package=mock_service
//
