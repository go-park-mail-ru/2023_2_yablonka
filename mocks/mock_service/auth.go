...
//
//	mockgen.exe --source=P:\VK Образование\Web\Sem_2\Project\2023_2_yablonka\internal\service\auth.go --destination=./mocks/mock_service/auth.go --package=mock_service
//
