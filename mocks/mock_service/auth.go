...
//
//	mockgen -source=auth.go -destination=../../mocks/mock_service/auth.go -package=mock_service
//
...
func (mr *MockIAuthServiceMockRecorder) GetLifetime(arg0 context.Context) *gomock.Call {
	mr.mock.ctrl.T.Helper()
