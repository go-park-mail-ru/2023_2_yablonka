...
//
//	mockgen.exe --source=P:\VK Образование\Web\Sem_2\Project\2023_2_yablonka\internal\service\list.go --destination=./mocks/mock_service/list.go --package=mock_service
//
...
func (m *MockIListService) UpdateOrder(arg0 context.Context, arg1 dto.ListIDs) error {
	m.ctrl.T.Helper()
...
func (mr *MockIListServiceMockRecorder) UpdateOrder(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateOrder", reflect.TypeOf((*MockIListService)(nil).UpdateOrder), arg0, arg1)
}
