...
//
//	mockgen.exe --source=P:\VK Образование\Web\Sem_2\Project\2023_2_yablonka\internal\service\user.go --destination=./mocks/mock_service/user.go --package=mock_service
//
