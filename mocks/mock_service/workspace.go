...
//
//	mockgen.exe --source=P:\VK Образование\Web\Sem_2\Project\2023_2_yablonka\internal\service\workspace.go --destination=./mocks/mock_service/workspace.go --package=mock_service
//
