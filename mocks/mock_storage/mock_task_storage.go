...
//
//	mockgen.exe --source=P:\VK Образование\Web\Sem_2\Project\2023_2_yablonka\internal\storage\task.go --destination=./mocks/mock_storage/mock_task_storage.go --package=mock_storage
//
