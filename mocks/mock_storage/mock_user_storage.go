...
//
//	mockgen.exe --source=P:\VK Образование\Web\Sem_2\Project\2023_2_yablonka\internal\storage\user.go --destination=./mocks/mock_storage/mock_user_storage.go --package=mock_storage
//
...
func (m *MockIUserStorage) UpdateAvatarUrl(arg0 context.Context, arg1 dto.AvatarUrlInfo) error {
	m.ctrl.T.Helper()
