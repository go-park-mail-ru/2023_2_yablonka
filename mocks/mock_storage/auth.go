...
//
//	mockgen.exe --source=P:\VK Образование\Web\Sem_2\Project\2023_2_yablonka\internal\storage\auth.go --destination=./mocks/mock_storage/auth.go --package=mock_storage
//
