...
//
//	mockgen.exe --source=P:\VK Образование\Web\Sem_2\Project\2023_2_yablonka\internal\storage\comment.go --destination=./mocks/mock_storage/comment.go --package=mock_storage
//
