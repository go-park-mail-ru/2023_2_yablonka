...
func TestNewBoardService(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := NewBoardService(tt.args.bs, tt.args.ls, tt.args.us, tt.args.cs, tt.args.cls, tt.args.clis, tt.args.conn); !reflect.DeepEqual(got, tt.want) {
